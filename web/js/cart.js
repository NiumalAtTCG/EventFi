...
//            window.location = "index.html";
            ...
            json.forEach(item => {
                ...
                cartItemRowClone.querySelector("#cart-item-a").href = "single_product_view.html?id=" + item.product.id;
                cartItemRowClone.querySelector("#cart-item-image").src = "product-images/" + item.product.id + "/"+ item.product.id +"image.png";
